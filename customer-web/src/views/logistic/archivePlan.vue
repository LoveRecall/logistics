  ...
  <div class="logistic-plan-overview">
    ...
    :data="tabData" @change-checked="changeChecked" :loading="tableLoading" :height="height" ref="tab" @change-sort="changeSort">
      <div slot="header">
        <div class="btn-wrap">
          <div class="fn btn">
            <el-button @click="sendRecover" v-authorize="['LOGISTICS:ARCHIVE:RECOVER','LOGISTICS:ARCHIVE:READ_ONLY']" :disabled="selectCount.length<=0">{{ $i.logistic.recover }}</el-button>
          </div>
